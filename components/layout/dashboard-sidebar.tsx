  ...
  return (
    ...
    >
      <div className={cn(sidebarBrandRowClass, isCollapsed && sidebarBrandRowCollapsedClass)}>
        <Link
          href="/dashboard"
          className="mx-auto inline-flex w-full max-w-full items-center justify-center rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent-border) focus-visible:ring-offset-2 focus-visible:ring-offset-bg-sidebar"
        ...
        >
          <AppLogo
            ...
            width={isCollapsed ? 28 : 216}
            height={isCollapsed ? 28 : 72}
          />
        </Link>
        {onClose ? (
          <button
