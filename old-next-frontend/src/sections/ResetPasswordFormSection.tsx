...
import type { ResetPasswordValues } from "./resetPassword.types.ts"
...
type ResetPasswordFormSectionProps = {
  ...
  /** Shown when `?password=reset-password` but token or email is missing */
  invalidLink?: boolean
}
  ...
  return (
    ...
    >
      ...
      {invalidLink ? (
        ...
        <>
          <Paragraph className="mt-2 text-sm leading-relaxed">
            {t("subtitle")}
          </Paragraph>
